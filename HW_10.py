...
Найбільше число-паліндром, одержане множенням двох двозначних чисел: 9009 = 91 × 99. Знайдіть найбільший паліндром,
 одержаний множенням двох трицифрових чисел. Виведіть значення цього паліндрому і те, vyj;tyyzv яких чисел він є."""
...
#
#
# print(sequences(0, 2, 4, 6, 8, 10, 12))
# print(sequences(1, 4, 7, 10, 13))
# print(sequences(1, 2, 4, 8, 16, 32))
# print(sequences(1, 3, 9, 27))
# print(sequences(1, 4, 9, 16, 25))
# print(sequences(1, 8, 27, 64, 125))
